...
const Contact = () => {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className='flex-[0.75] bg-black-100 p-8 rounded-2xl max-w-[500px] w-full'
      >
  ...
  <a
    href='https://www.linkedin.com/in/mohamed-amine-aanzour-43a6b52ab/'
    target='_blank'
    rel='noopener noreferrer'
    className='bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary flex items-center justify-center'
  >
    LinkedIn
  </a>
  <motion.a
